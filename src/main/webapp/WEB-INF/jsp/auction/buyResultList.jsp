...
<body>
    ...
    <div class="page-buttons">
            ...
            <c:if test="${productList.page > 0}">
                <form action="/myPage/buyAuction2.do?pageName=previous" method="get" style="display: inline;">
            ...
            <c:if test="${productList.page + 1 < productList.pageCount}">
                <form action="/myPage/buyAuction2.do?pageName=next" method="get" style="display: inline;">
